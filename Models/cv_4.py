...
# Split train_generator_1 into train and test data
train_data_1, test_data_1 = train_test_split(train_generator_1, test_size=0.2)

# Split train_generator_2 into train and test data
train_data_2, test_data_2 = train_test_split(train_generator_2, test_size=0.2)

# Split train_generator_2_filtered into train and test data
...
# Define train data and model names
