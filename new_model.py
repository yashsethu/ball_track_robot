...
def train_additional_model(X_train, y_train):
    ...
    try:
        additional_history = additional_model.fit(
...
train_additional_model(additional_X_train, additional_y_train)
...
X_train = None  # Update with the appropriate training data
y_train = None  # Update with the appropriate training labels
...
train_additional_model(X_train, y_train)
