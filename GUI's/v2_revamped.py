...
def update_performance_data():
    # Update CPU, memory, and disk usage labels
...
# Create labels for performance data
...
# Update performance data initially and then periodically
update_performance_data()

# Handle five-way navigation input
