...
up_button.when_pressed = lambda: handle_button("up")
down_button.when_pressed = lambda: handle_button("down")
left_button.when_pressed = lambda: handle_button("left")
right_button.when_pressed = lambda: handle_button("right")
