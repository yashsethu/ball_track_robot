...
# Track the movement of the detected faces
prev_faces = []
for x, y, w, h in faces:
    ...
    # Check if the face has moved significantly from the previous frame
    face_moved = False
    for prev_x, prev_y, _, _ in prev_faces:
        prev_centroid_x = prev_x + prev_w // 2
        prev_centroid_y = prev_y + prev_h // 2
        distance = (
    ...
    # Perform actions based on face movement
    if face_moved:
